...
import sys
sys.path.append(".")
from utils.utils import build_data_loader, evaluate_model
...
def main():
    ...
    train_dataloader = build_data_loader("data/train.p", batch_size=args.train_batch_size)
    ...
    model = GraphEmbeddingEncoder(embeddings, args.embedding_dim, args.compressed_dim, args.final_dim)
    ...
    for epoch in range(epochs):
        ...
        dev_avg_loss = evaluate_model("data/dev.p", model, loss_function)
    ...
    with open("data/result_data/loss_per_epoch_{}_{}_{}.csv".format(args.experiment_name, epoch_string), "w") as f:
        writer=csv.writer(f)
